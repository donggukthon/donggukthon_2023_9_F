import BoxLarge from "../../components/DarkBox/BoxLarge";
...
export const TestResult6 = () => {
  return (
    <Testresult1Root>
      ...
      <Component1 description="#겉바속바 " propLeft="65px" />
      <Component1 description="#쿨하고차갑" propLeft="154px" />
      <Component1 description="#거리감있는" propLeft="243px" />
      <Div3>날이 선 얼음 덩어리형</Div3>
      <B>
        <Ul>
          <Li>{`겉으로는 차가운 얼음덩어리처럼 보이며, 속으로도 감정을 쉽게 드러내지 않는 눈사람입니다. `}</Li>
          <Li>{`무관심한 표정과 거리를 두는 태도로 주변에 일정한 거리를 유지하며, 감정을 표현하는 것을 꺼리는 편입니다.`}</Li>
          <Li2>
          이성친구들에게는 쿨한 친구로 인식되지만, 간혹 마음을 터놓을 수 있는 이성친구가 생기면, 그 안에 감춰진 따뜻한 마음을 알아채게 될 수도 있어요!
          </Li2>
        </Ul>
      </B>
